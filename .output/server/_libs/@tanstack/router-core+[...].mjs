import {
  C as createInlineCssPlaceholderAsset,
  E as getStylesheetHref,
  F as createLRUCache,
  I as invariant,
  L as decodePath,
  N as rootRouteId,
  S as TSR_SCRIPT_BARRIER_ID,
  w as createInlineCssStyleAsset,
  x as GLOBAL_TSR,
...
function createBaseDeserializerContext(mode, options) {
  ...
  const maxBase64Length =
    (_options$maxBase64Len = options.maxBase64Length) !== null &&
    _options$maxBase64Len !== void 0
