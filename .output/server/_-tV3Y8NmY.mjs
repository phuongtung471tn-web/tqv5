...
function CatchAll() {
  ...
  if (adminPath && slug === adminPath)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminLoginPage, {});
  ...
  if (page) {
    ...
    const pageSections = (page.sectionIds || [])
      ...
      .filter((section) => Boolean(section && section.enabled));
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
      className: "min-h-screen bg-background",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
          className:
            "sticky top-0 z-40 border-b border-border/60 bg-background/90 px-4 py-3 backdrop-blur",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
            className:
              "mx-auto flex max-w-6xl items-center justify-end gap-3 overflow-x-auto",
          ...
          children: [
            ...
            page.ctaLabel &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
                href: page.ctaHref || "/",
                className:
                  "mt-6 inline-flex rounded-lg bg-primary px-5 py-3 font-bold text-primary-foreground",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className: "mt-8",
          children: pageSections.map((section) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              ContentSection,
              { section },
              section.id,
