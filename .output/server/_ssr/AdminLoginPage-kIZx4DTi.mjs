...
import { h as useSiteConfig } from "./use-site-config-Bf44Q8nb.mjs";
import { n as useAdmin } from "./use-admin-BM5hUDJ4.mjs";
import { v as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { x as Lock } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AdminLoginPage-kIZx4DTi.js
...
function AdminLoginPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
    className:
      "flex min-h-screen items-center justify-center bg-neutral-950 px-4 text-white",
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className:
        "w-full max-w-sm rounded-2xl bg-neutral-900 p-6 ring-1 ring-white/10",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-white/10",
          ...
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                  onClick: () => navigate({ to: "/" }),
                  className:
                    "w-full rounded-lg bg-white py-2.5 text-sm font-bold text-neutral-900",
          ...
          : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                  ...
                  autoFocus: true,
                  className:
                    "w-full rounded-lg bg-neutral-800 px-3 py-2.5 text-sm outline-none ring-1 ring-white/10 focus:ring-white/30",
                }),
                error &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                  type: "submit",
                  className:
                    "w-full rounded-lg bg-white py-2.5 text-sm font-bold text-neutral-900 transition-opacity hover:opacity-90",
                  children: "Đăng nhập",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
