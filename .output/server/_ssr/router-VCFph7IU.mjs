...
import {
  a as clearAnalytics,
  d as saveLead,
  f as testSupabaseConnection,
  h as useSiteConfig,
  i as SiteConfigProvider,
  l as loadAnalytics,
  m as trackVisit,
  n as DEFAULT_CONFIG,
  o as clearLeads,
  s as exportLeadsCsv,
  t as ANALYTICS_UPDATED_EVENT,
  u as loadLeads,
...
import {
  a as resetVariant,
  c as testWebhookEndpoint,
  d as utmSource,
  f as webhookConfigurationWarning,
  i as getVariant,
  r as fireTestEvent,
  s as sendTestEmail,
  t as checkEmailConfig,
...
function DeviceFrame({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", {
      ...
      className:
        "rounded-2xl border-[10px] border-neutral-900 bg-background shadow-2xl",
    }),
  });
}
var TOOLS = [
...
function AdminBar() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "sticky top-0 z-[90] border-b border-white/10 bg-neutral-950 text-white",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "shrink-0 rounded-md bg-white/10 px-2 py-1 text-[10px] font-bold uppercase tracking-wide",
            children: "Admin",
          }),
            ...
            children: TOOLS.map((t) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "button",
                {
                  ...
                  title: t.label,
                  className:
                    "flex shrink-0 items-center gap-1.5 rounded-md px-2 py-1.5 text-[11px] font-medium text-white/70 transition-colors hover:bg-white/10 hover:text-white",
                  children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex items-center gap-1.5 overflow-x-auto border-t border-white/10 px-2 py-1.5",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "shrink-0 text-[10px] font-semibold uppercase tracking-wide text-white/40",
            children: "Xem thử",
          }),
          DEVICES.map((d) => {
            const Icon = d.icon;
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
            className:
              "ml-auto flex shrink-0 items-center gap-1 text-[10px] text-white/60",
            children: [
              "Rộng",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                ...
                className:
                  "w-16 rounded border border-white/20 bg-white/10 px-1.5 py-1 text-center text-[11px] text-white",
              }),
              "Cao",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            className:
              "shrink-0 rounded-md bg-white/10 px-2 py-1.5 text-[11px] font-semibold text-white/70 hover:bg-white/20 hover:text-white",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex items-center gap-1.5 border-t border-white/10 px-2 py-1.5",
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
            onClick: exportFile,
            className:
              "flex items-center gap-1.5 rounded-md bg-white/10 px-3 py-1.5 text-[11px] font-bold text-white/80 transition-colors hover:bg-white/20",
            children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
            onClick: logout,
            className:
              "ml-auto flex items-center gap-1.5 rounded-md bg-red-500/20 px-3 py-1.5 text-[11px] font-bold text-red-300 transition-colors hover:bg-red-500/30",
            children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "flex items-start justify-between gap-3 border-b border-neutral-200 px-4 py-3 dark:border-white/10",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              "aria-label": "Đóng",
              className:
                "rounded-md p-1.5 text-neutral-500 hover:bg-neutral-100 dark:hover:bg-white/10",
...
function Field({ label, hint, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
        className:
          "mb-1 block text-xs font-semibold text-neutral-700 dark:text-neutral-300",
        children: label,
      }),
      children,
      hint &&
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: ["recentLeads", "sample"].map((source) =>
    ...
    children: [
      ...
      form.fields.map((field, i) =>
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          ...
          {
            className:
              "mb-2 grid grid-cols-2 gap-2 rounded-lg border border-neutral-200 p-2",
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextInput, {
                ...
                onChange: (e) =>
                  update(
                    (d) => (d.form.fields[i].placeholder = e.target.value),
                  ),
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                  ...
                  value: t.gold,
                  onChange: (e) =>
                    update((d) => (d.theme.gold = e.target.value)),
                  className: "h-9 w-12 rounded border border-neutral-300",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextInput, {
                  value: t.gold,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className: "flex gap-2",
          children: ["endOfMonth", "fixed"].map((m) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            className:
              "w-full rounded-lg bg-neutral-900 py-2.5 text-sm font-bold text-white dark:bg-white dark:text-neutral-900",
...
function EmailModal({ onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "mb-3 rounded-lg bg-sky-50 px-3 py-2 text-[11px] leading-relaxed text-sky-800",
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
            children: "GMAIL_CLIENT_ID",
          }),
          ", ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
            children: "GMAIL_CLIENT_SECRET",
          }),
          ", ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
            children: "GMAIL_REFRESH_TOKEN",
          }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
        ...
        className:
          "w-full rounded-lg border border-neutral-300 py-2.5 text-xs font-bold disabled:opacity-40",
        children:
          testState === "testing"
            ? "Đang kiểm tra..."
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
            className: "mt-1",
            children:
              "Hãy bấm test sau khi nhập URL. Trình duyệt có thể chặn endpoint không bật CORS; khi đó nên dùng Make/Zapier làm cổng trung gian.",
          }),
        ],
      }),
      list.length === 0 &&
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                    value: w.type,
                    onChange: (e) =>
                      update((d) => (d.webhooks[i].type = e.target.value)),
                    className:
                      "rounded-lg border border-neutral-300 px-2 py-2 text-sm",
                    children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                className:
                  "mt-2 w-full rounded-lg border border-neutral-300 py-2 text-xs font-bold disabled:opacity-40",
                children:
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
        ...
        className:
          "flex w-full items-center justify-center gap-1.5 rounded-lg border border-dashed border-neutral-300 py-2.5 text-sm font-semibold text-neutral-600",
        children: [
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
          ...
          className:
            "rounded-lg border border-red-200 px-3 py-1.5 text-[11px] font-bold text-red-600",
          ...
          a && Object.keys(a.bySourceStats).length > 0
            ? Object.entries(a.bySourceStats).map(([s, stats]) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  ...
                  {
                    className:
                      "flex justify-between rounded-lg bg-neutral-100 px-3 py-1.5 text-xs dark:bg-white/5",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
      ...
      a && Object.keys(a.byVariant).length > 0
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className: "grid grid-cols-2 gap-2",
            children: Object.entries(a.byVariant).map(([v, s]) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  className:
                    "rounded-lg border border-neutral-200 p-2 text-xs dark:border-white/10",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: "font-bold",
                      children: v,
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: ["Visits: ", s.visits],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: ["Leads: ", s.leads],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        "CR: ",
                        s.visits
                          ? ((s.leads / s.visits) * 100).toFixed(1)
                          : "0",
                        "%",
                      ],
                    }),
        ...
        : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
            className: "text-xs text-neutral-400",
            children:
              "A/B chưa có dữ liệu. Hãy bật A/B Testing, lưu cấu hình, mở landing ở tab mới rồi tải lại Analytics.",
          }),
    ],
  });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
            ...
            className:
              "flex items-center gap-1.5 rounded-lg bg-neutral-900 px-3 py-2 text-xs font-bold text-white disabled:opacity-40",
            children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: addTestLead,
            className:
              "rounded-lg border border-neutral-300 px-3 py-2 text-xs font-bold text-neutral-700",
            children: "+ Lead thử",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: () => {
            ...
            className:
              "ml-auto rounded-lg bg-red-50 px-3 py-2 text-xs font-bold text-red-600 disabled:opacity-40",
            children: "Xoá tất cả",
          }),
        ],
      }),
      ...
      filtered.length === 0
        ...
        : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "mt-3 overflow-x-auto rounded-xl border border-neutral-200 dark:border-white/10",
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
              className: "w-full min-w-[560px] text-left text-xs",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
                  className:
                    "bg-neutral-100 text-[10px] uppercase tracking-wide text-neutral-500 dark:bg-white/5",
                            ...
                            children: [
                              ...
                              l.aiRank &&
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                  ...
                                  {
                                    className:
                                      "ml-1.5 rounded bg-amber-100 px-1.5 text-[10px] font-bold text-amber-700",
                                    children: l.aiRank,
                                  },
                                ),
                            ],
          ...
          import_jsx_runtime.Fragment,
          {
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                className:
                  "mb-3 rounded-lg bg-neutral-900 px-3 py-2 text-xs font-bold text-white",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: handleSave,
            className:
              "flex-1 rounded-lg bg-emerald-500 py-2.5 text-sm font-bold text-white",
            children: "LƯU & ÁP DỤNG",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: () => window.open(`/${path}`, "_blank", "noopener"),
            className:
              "flex-1 rounded-lg border border-neutral-300 py-2.5 text-sm font-bold dark:border-white/20",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
        ...
        children:
          "Lưu ý: đây là mật khẩu phía client cho tiện chỉnh sửa nhanh. Với dữ liệu nhạy cảm hãy dùng Supabase Row Level Security.",
      }),
    ],
  });
}
function AbTestModal({ onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "mb-3 rounded-lg bg-neutral-100 px-3 py-2 text-xs dark:bg-white/5",
        children: [
          "Thiết bị này đang ở ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", {
            children: [
              "Variant ",
              ab.enabled ? currentVariant : "A (A/B đang tắt)",
            ],
          }),
          ".",
        ],
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
        ...
        className:
          "mt-2 w-full rounded-lg border border-amber-300 px-3 py-2 text-xs font-bold text-amber-700",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className: "flex gap-2",
          children: ["off", "daily", "weekly"].map((s) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
        ...
        children:
          "Cron chạy phía Supabase Edge Function / cron-job.org khi ở Database Mode. Ở Local Mode, mỗi lần LƯU sẽ tạo snapshot backup tự động (giữ 10 bản gần nhất).",
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SaveHint, {}),
    ],
  });
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
      ...
      children: points.map((p) =>
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          ...
          {
            className:
              "flex gap-2 rounded-lg bg-neutral-100 px-3 py-2 text-xs text-neutral-700 dark:bg-white/5 dark:text-neutral-200",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function LandingEditorModal({ onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            className:
              "rounded-lg bg-neutral-900 px-2 py-2 text-xs font-bold text-white",
            children: "Xuất JSON",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: () => importRef.current?.click(),
            className:
              "rounded-lg border border-neutral-300 px-2 py-2 text-xs font-bold",
            children: "Nhập JSON",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: () => {
            ...
            className:
              "rounded-lg border border-amber-300 px-2 py-2 text-xs font-bold text-amber-700",
            children: "Khôi phục",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: () => save(),
            className:
              "rounded-lg bg-emerald-600 px-2 py-2 text-xs font-bold text-white",
            children: "Lưu ngay",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
            ref: importRef,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "mb-4 rounded-xl border border-neutral-200 p-3 dark:border-white/10",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: content.sectionsArray.map((item, index) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  className:
                    "flex items-center gap-1.5 rounded-lg bg-neutral-50 p-1.5 text-xs dark:bg-white/5",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      ...
                      className:
                        "rounded border border-red-200 px-2 py-1 text-red-600",
                      "aria-label": "Xóa",
                      children: "×",
                    }),
                  ],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                ...
                className:
                  "rounded-lg border border-neutral-300 bg-white px-2 py-2 text-xs dark:bg-neutral-800",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
                    value: "promo",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "mb-3 rounded-xl border border-neutral-200 p-3 dark:border-white/10",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, {
                ...
                onChange: (value) =>
                  update((d) => (d.landing.showLogo = value)),
                label: "",
              }),
            ],
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-neutral-100 ring-1 ring-neutral-200 dark:bg-white/10 dark:ring-white/10",
                children: content.logoUrl
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        ...
                        className:
                          "rounded-lg bg-neutral-900 px-3 py-2 text-xs font-bold text-white",
                      ...
                      content.logoUrl &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                          type: "button",
                          onClick: () =>
                            update((d) => (d.landing.logoUrl = "")),
                          className:
                            "rounded-lg border border-red-200 px-3 py-2 text-xs font-bold text-red-600",
                          children: "Xóa logo",
                        }),
                    ],
                  }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            Field,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextInput, {
                value: content[key],
                onChange: (e) =>
                  update((d) => (d.landing[key] = e.target.value)),
              }),
            },
            key,
          ),
...
function PagesModal({ onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            className:
              "flex-1 rounded-lg bg-neutral-900 px-3 py-2 text-xs font-bold text-white",
            children: "+ Trang mới",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            type: "button",
            ...
            className:
              "flex-1 rounded-lg border border-neutral-300 px-3 py-2 text-xs font-bold",
            children: "+ Thank You",
          }),
        ],
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "mb-4 flex gap-1 overflow-x-auto border-b border-neutral-200 pb-2",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, {
          ...
          children: [
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              "button",
                              {
                                type: "button",
                                onClick: () =>
                                  detachSectionFromPage(section.id),
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              ...
                              {
                                value:
                                  section.content?.buttonHref || "#dang-ky",
                                onChange: (event) =>
                                  updatePageSection(section.id, {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children: Object.entries(SECTION_LIBRARY).map(
                ([type, template]) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "button",
                    {
                      ...
                      className:
                        "rounded-lg border border-dashed border-neutral-300 px-2 py-1.5 text-left text-[11px] font-semibold hover:border-primary",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
        ...
        className:
          "w-full rounded-lg border border-red-200 py-2 text-xs font-bold text-red-600 disabled:opacity-40",
...
function GuideModal({ onClose }) {
  ...
  const checks = [
    ...
    {
      label: "TikTok Pixel",
      ok: !!config.tracking.tiktokPixelId,
    },
    {
    ...
    {
      label: "Hotline/Zalo",
      ok: !!config.floatingContact.hotline,
    },
    {
      label: "Storage mode",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminModal, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: checks.map((c) =>
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            ...
            {
              className:
                "flex items-center justify-between rounded-lg border border-neutral-200 px-3 py-2 text-xs dark:border-white/10",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                  children: c.label,
                }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
        className:
          "list-decimal space-y-1.5 pl-5 text-xs text-neutral-600 dark:text-neutral-300",
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
            children:
              "Bấm LƯU để áp dụng (localStorage) hoặc XUẤT CONFIG để tải file dán vào mã nguồn.",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
            children:
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
            children:
              "Vào Cổng Webhook & Đa Kênh, bấm test từng endpoint và chỉ chạy Ads khi các kênh cần thiết trả về OK.",
          }),
        ],
      }),
    ],
...
function SaveHint() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    className:
      "sticky bottom-0 -mx-4 mt-4 border-t border-neutral-200 bg-white px-4 pb-1 pt-3 dark:border-white/10 dark:bg-neutral-900",
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
      onClick: save,
...
function RootComponent() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
    client: queryClient,
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteConfigProvider, {
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminProvider, {
        children: [
