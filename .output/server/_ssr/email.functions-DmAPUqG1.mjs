...
var checkEmailConfig = createServerFn({ method: "GET" }).handler(
  checkEmailConfig_createServerFn_handler,
  () => ({
    resendConfigured: Boolean(processModule.env["RESEND_API_KEY"]),
    gmailConfigured: Boolean(
      processModule.env["GMAIL_CLIENT_ID"] &&
      processModule.env["GMAIL_CLIENT_SECRET"] &&
      processModule.env["GMAIL_REFRESH_TOKEN"],
    ),
  }),
);
...
var sendLeadEmail = createServerFn({ method: "POST" })
  .validator((data) => schema.parse(data))
  .handler(sendLeadEmail_createServerFn_handler, async ({ data }) => {
...
var sendTestEmail = createServerFn({ method: "POST" })
  .validator((data) => schema.parse(data))
...
export {
  checkEmailConfig_createServerFn_handler,
  sendLeadEmail_createServerFn_handler,
