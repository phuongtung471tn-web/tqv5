...
//#region node_modules/.nitro/vite/services/ssr/assets/ContentSection-BVP0UsCM.js
...
function ContentSection({ section }) {
  ...
  const youtubeId = (section.content?.buttonHref || "").match(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    ...
    children: [
      variant === "video" && youtubeId
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "mb-6 aspect-video overflow-hidden rounded-2xl bg-neutral-900",
      ...
      variant === "faq" && section.content?.body
        ...
        : variant === "pricing" || variant === "grid"
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
              ...
              children: (bodyLines.length
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  ...
                  {
                    className:
                      "rounded-xl border border-border bg-card p-3 text-sm leading-relaxed",
                    children: ["✓ ", line],
                  },
                  line,
                ),
          ...
          : section.content?.body &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              className:
                "mt-3 max-w-3xl whitespace-pre-line text-muted-foreground",
              children: section.content.body,
            }),
      variant === "countdown" &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      ...
      section.content?.buttonLabel &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
          ...
          className:
            "mt-6 inline-flex rounded-xl bg-primary px-5 py-3 font-bold text-primary-foreground",
