import { _ as e, b as t, v as n, y as r } from "./createLucideIcon-DPqBjfMm.js";
import { n as i, t as a } from "./invariant-D46wnQWo.js";
import { i as o } from "./use-admin-B_Pi3CKv.js";
function s(e) {
  return e[e.length - 1];
}
function c(e) {
...
function le(e, t, n, r, i) {
  ...
  return (
    o ||
      ((o = F(`/`)),
      M(t, new Uint16Array(6), { from: e }, 1, o, 0),
...
function ye({ path: e, params: t, decoder: n, ...r }) {
  let i = !1,
    a = Object.create(null);
  if (!e || e === `/`)
...
var xe = `Error preloading route! ☝️`,
  Z = t(n(), 1),
  Se = Z.use,
  Ce = typeof window < `u` ? Z.useLayoutEffect : Z.useEffect;
function we(e) {
...
var De = e();
function Oe({ children: e, fallback: t = null }) {
  return ke()
    ? (0, De.jsx)(Z.Fragment, { children: e })
    : (0, De.jsx)(Z.Fragment, { children: t });
}
function ke() {
...
var je = Z.createContext(void 0),
  Me = Z.createContext(void 0),
  Ne = r((e) => {
    var t = n();
    function r(e, t) {
...
function Re(e, t, n = Le) {
  ...
  return (0, Ie.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
var ze = {
  get() {},
  subscribe() {
...
function We(e, t) {
  let n = o(),
    ...
    ce = L.maskedLocation ? L.maskedLocation.publicHref : L.publicHref,
    le = L.maskedLocation ? L.maskedLocation.external : L.external,
    R = Z.useMemo(() => Ze(ce, le, n.history, x), [x, le, ce, n.history]),
    z = Z.useMemo(() => {
      if (R?.external) return ee(R.href, n.protocolAllowlist) ? void 0 : R.href;
      if (!Qe(c) && typeof c == `string` && c.indexOf(`:`) !== -1)
        try {
          return (new URL(c), ee(c, n.protocolAllowlist) ? void 0 : c);
        } catch {}
    }, [c, R, n.protocolAllowlist]),
    B = Z.useMemo(() => {
      if (z) return !1;
      if (s?.exact) {
        if (!he(I.pathname, L.pathname, n.basepath)) return !1;
      } else {
    ...
    V = B ? (l(i, {}) ?? Ke) : Ge,
    H = B ? Ge : (l(a, {}) ?? Ge),
    U = [C, V.className, H.className].filter(Boolean).join(` `),
    ue = (S || V.style || H.style) && { ...S, ...V.style, ...H.style },
    [de, W] = Z.useState(!1),
    fe = Z.useRef(!1),
    G = e.reloadDocument || z ? !1 : (u ?? n.options.defaultPreload),
    K = d ?? n.options.defaultPreloadDelay ?? 0,
    q = Z.useCallback(() => {
      n.preloadRoute({ ...F, _builtLocation: L }).catch((e) => {
        (console.warn(e), console.warn(xe));
      });
    }, [n, F, L]);
  (Te(
    r,
    ...
    Z.useEffect(() => {
      fe.current || (!x && G === `render` && (q(), (fe.current = !0)));
    }, [x, q, G]));
  let J = (e) => {
...
var Ge = {},
  Ke = { className: `active` },
  qe = { role: `link`, "aria-disabled": !0 },
  Je = { "data-status": `active`, "aria-current": `page` },
