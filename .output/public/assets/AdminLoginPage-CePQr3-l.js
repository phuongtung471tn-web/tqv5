...
import { n as a, r as o } from "./use-admin-B_Pi3CKv.js";
var s = r(`lock`, [
    [
      `rect`,
      {
  ...
  l = e();
function u() {
  let { authed: e, login: t } = a(),
    { config: r } = n(),
    i = o(),
    [u, d] = (0, c.useState)(``),
    [f, p] = (0, c.useState)(!1);
  function m(e) {
    (e.preventDefault(), t(u, r.admin.password) ? i({ to: `/` }) : p(!0));
  }
  return (0, l.jsx)(`main`, {
        ...
        (0, l.jsxs)(`div`, {
          ...
          children: [
            (0, l.jsx)(`div`, {
              ...
              children: (0, l.jsx)(s, { className: `h-5 w-5` }),
            }),
            (0, l.jsx)(`h1`, {
