import { _ as e, b as t, v as n } from "./createLucideIcon-DPqBjfMm.js";
var r = t(n(), 1),
...
function d({ children: e }) {
  let [t, n] = (0, r.useState)(!1),
    ...
    [o, d] = (0, r.useState)(`desktop`),
    [f, p] = (0, r.useState)(l);
  (0, r.useEffect)(() => {
    try {
      n(window.sessionStorage.getItem(c) === `1`);
      let e = window.localStorage.getItem(`funnel_admin_device_sizes_v1`);
      e && p({ ...l, ...JSON.parse(e) });
    } catch {}
  }, []);
  ...
  return (0, s.jsx)(u.Provider, { value: v, children: e });
}
function f() {
  let e = (0, r.useContext)(u);
  if (!e) throw Error(`useAdmin must be used within AdminProvider`);
  return e;
}
export { i as a, a as i, f as n, o as r, d as t };
