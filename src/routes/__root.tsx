...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Trung tâm Hướng nghiệp & Phát triển Sự nghiệp Quốc tế" },
    ...
    scripts: [
      // ================== TRACKING SCRIPTS ==================
      // 1) Facebook Pixel — replace YOUR_PIXEL_ID
      {
        children: `
...
`,
      ...
      // 2) TikTok Pixel — replace YOUR_TIKTOK_PIXEL_ID inside ttq.load()
      {
        children: `
...
`,
      ...
      // 3) Google Ads / GA4 — replace AW-XXXXXXXXX (also in src/lib/tracking.ts)
      {
        children: `
